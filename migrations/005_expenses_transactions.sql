-- Safety migration for early repos:
-- If 002_init_expenses.sql was previously a placeholder but marked applied,
-- this ensures expenses_transactions exists anyway (idempotent).
